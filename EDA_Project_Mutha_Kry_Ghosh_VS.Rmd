...
colnames(generation_rene) <- c("Region", "Total renewable generation")
colnames(generation_nonrene) <- c("Region", "Total non-renewable generation")
...
colnames(distribution_rene) <- c("Region","Hydro","Biomass","Wind","Solar","Geothermal")
