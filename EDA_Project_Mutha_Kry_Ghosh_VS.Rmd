...
summary.pollution <- egrid_subset %>%
  ...
  rename("NOx" = STNOXAN,
         "SO2" = STSO2AN,
         "CO2" = STCO2AN,
         "CO2 equivalent" = STCO2EQA) %>%
  pivot_longer(cols = c("NOx",
                        "SO2",
                        "CO2",
                        "CO2 equivalent"),
               names_to = "variable", values_to = "value") %>%
...
summary.table.pollution <- summary.pollution %>%
  ...
  tab_header(
    title = md("Table 2: Summary Statistics of Pollutants Emitted Annually Per Region (in 1000 tons)")) %>%
...
[Link to Project repository on GitHub](https://github.com/Srishtimutha/EDA_Class_Project_Sp23)
