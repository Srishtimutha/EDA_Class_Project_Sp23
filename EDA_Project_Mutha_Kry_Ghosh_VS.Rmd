...
```{r Q2plot, echo=FALSE, fig.cap="Distribution of different renewable energy generation sources across BEA regions of USA in 2021", fig.align='center', fig.width=6.5}
renewable_energy_plot
```
\newpage
