...
```{r}
#aqi ~ renewable energy consumption + gdp_pc + 
#renewable energy consumption ~ gdp_pc
#variables to consider: aqi, mortality rate, gdp_pc, Renewable energy consumption %
#aqi ~ renewable energy % (from separate datasets)
#Ask Luana for other ideas for linear models, what the independent and dependent variables and controls
